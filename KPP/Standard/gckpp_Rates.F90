...
! End INLINED RCONST
  ...
  RCONST(1) = (GCJPLPR(1.46E-32,1.86,0.0,1.46e-11,1.86,0.0,0.6,0.0,0.0))
  RCONST(2) = (GCJPLPR(1.6E-9,1.86,-7801.0,1.6E12,1.86,-7801.0,0.6,0.0,0.0))
  RCONST(3) = (GCARR(3.9E-11,0.0,0.0))
  RCONST(4) = (GCJPLPR(7.1E-29,4.5,0.0,1.2e-10,1.90,0.0,0.6,0.0,0.0))
  RCONST(5) = (GCJPLPR(2.3E-29,4.4,0.0,6.9e-11,2.40,0.0,0.6,0.0,0.0))
  RCONST(6) = (GCJPLPR(2.3E-29,4.4,0.0,6.9e-11,2.40,0.0,0.6,0.0,0.0))
  RCONST(7) = (GCJPLPR(2.3E-29,4.4,0.0,6.9e-11,2.40,0.0,0.6,0.0,0.0))
  RCONST(8) = (GCJPLPR(2.3E-29,4.4,0.0,6.9e-11,2.40,0.0,0.6,0.0,0.0))
  RCONST(9) = (GCARR(3.0E-11,0.0,0.0))
  RCONST(10) = (GCARR(3.0E-11,0.0,0.0))
  RCONST(11) = (GCARR(4.1E-12,0.0,-856.0))
  RCONST(12) = (GCARR(6.0E-11,0.0,-550.0))
  RCONST(13) = (GCJPLPR(2.2E-32,0.00E+00,0.0,1.0e-11,1.86,0.0,0.6,0.0,0.0))
  RCONST(14) = (GCARR(1.2E-11,0.0,-5942.0))
  RCONST(15) = (GCJPLPR(1.33E-30,0.0E+00,1185.0,1.0e-10,0.00,0.0,0.6,0.0,0.0))
  RCONST(16) = (GCJPLPR(4.25E-31,0.0E+00,1185.0,7.5e-11,0.00,0.0,0.6,0.0,0.0))
  RCONST(17) = (GCJPLPR(4.25E-31,0.0E+00,1185.0,7.5e-11,0.00,0.0,0.6,0.0,0.0))
  RCONST(18) = (GCJPLPR(4.25E-31,0.0E+00,1185.0,7.5e-11,0.00,0.0,0.6,0.0,0.0))
  RCONST(19) = (GCARR(3.0E-11,0.0,0.0))
  RCONST(20) = (GCJPLPR(4.25E-31,0.0E+00,1185.0,7.5e-11,0.00,0.0,0.6,0.0,0.0))
  RCONST(21) = (GCARR(3.0E-11,0.0,0.0))
  RCONST(22) = (GCARR(4.1E-12,0.0,-856.0))
  RCONST(23) = (GCARR(6.0E-11,0.0,-550.0))
  RCONST(24) = (HET(ind_HGBRNO2,1))
  RCONST(25) = (HET(ind_HGBRHO2,1))
  RCONST(26) = (HET(ind_HGBROH,1))
  RCONST(27) = (HET(ind_HGBRBRO,1))
  RCONST(28) = (HET(ind_HGBRCLO,1))
  RCONST(29) = (HET(ind_HGBR2,1))
  RCONST(30) = (HET(ind_HGCLNO2,1))
  RCONST(31) = (HET(ind_HGCLHO2,1))
  RCONST(32) = (HET(ind_HGCLOH,1))
  RCONST(33) = (HET(ind_HGCLBRO,1))
  RCONST(34) = (HET(ind_HGCLCLO,1))
  RCONST(35) = (HET(ind_HGCLBR,1))
  RCONST(36) = (HET(ind_HGBRNO2,2))
  RCONST(37) = (HET(ind_HGBRHO2,2))
  RCONST(38) = (HET(ind_HGBROH,2))
  RCONST(39) = (HET(ind_HGBRBRO,2))
  RCONST(40) = (HET(ind_HGBRCLO,2))
  RCONST(41) = (HET(ind_HGBR2,2))
  RCONST(42) = (HET(ind_HGCLNO2,2))
  RCONST(43) = (HET(ind_HGCLHO2,2))
  RCONST(44) = (HET(ind_HGCLOH,2))
  RCONST(45) = (HET(ind_HGCLBRO,2))
  RCONST(46) = (HET(ind_HGCLCLO,2))
  RCONST(47) = (HET(ind_HGCLBR,2))
  RCONST(48) = (PHOTOL(18))
  RCONST(49) = (PHOTOL(19))
  RCONST(50) = (PHOTOL(20))
  RCONST(51) = (PHOTOL(4))
